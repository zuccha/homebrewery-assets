...
Adventurers! Explore the Sunbathed Cave, in search of the rare and valued _star musk_. This short D&D 5e (2024) side quest is designed for a party of four to five 2nd-level characters. It should take no more than five hours to complete and features a handful of encounters and puzzles.
...
The players have been tasked with retrieving _star musk_ from the inner chambers of the Sunbathed Cave and bringing back as much as they can.

Details such as the cave’s location, the purpose of the musk, and the urgency of the quest are left to the GMs running this mini-adventure.

{{note
##### Example: A Cursed Sleep

Some inhabitants of a forest village have fallen into a deep slumber, a cursed sleep from which they can’t be awakened without magical aid. The village elder tasks the adventurers with retrieving _star musk_, the key ingredient of the antidote, from the abandoned Sunbathed Cave, once a harvesting site for the musk, now reclaimed by the wilderness. The amount of musk the party recovers determines how many potions the local alchemist can brew and, therefore, how many villagers can be freed from the curse.
}}

## Star Musk

_Star musk_ is a deep, dark green plant that turns golden yellow and begins to glimmer after a few minutes of sunlight. This exposure not only changes the plant’s color but also activates its medicinal properties. For this transformation to occur, the musk must be exposed to sunlight **before it is harvested**; sunlight applied afterward has no effect.
...
Years ago, the locals used the cave as a harvesting site, taking advantage of its natural sunlight to awaken the musk’s medicinal properties. To bathe the plants in sunlight before harvesting, they carved windows into the rock and installed reflecting mirrors.

More recently, the cave has become a dangerous place. A colony of rust monsters spread through the tunnels, a group of myconids turned a few chambers into their home, and a pair of ogres claimed the deepest room. These inhabitants form an unlikely symbiosis.
...
The adventurers must explore the cave to retrieve as much _star musk_ as possible. The plant grows in the three main chambers of the cave (areas 6, 7, and 8), each equipped with a different method for exposing the musk to sunlight before it’s harvested:

* **Northeast room (6):** Requires four mirrors to reflect sunlight from the cave's entrance to the chamber; three are missing and scattered in areas 3, 6, and 7.
...
| Result | Footprints                             |
|:-------|:---------------------------------------|
| 9-     | No useful information.                 |
| 10-14  | Various recent footprints are visible. |
| 15-19  | Some of the tracks belong to an ogre.  |
...
{{descriptive
Thick, dense layers of spiderweb fill this narrow passage. Venturing into the tangled mass is an undertaking best left to the brave and capable.
}}

The tunnel is only 1.5 meters wide and 2.5 meters tall. Two giant wolf spiders have turned the passage into their nest, weaving webs to ensnare unlucky travelers.
...
{{descriptive
A large, open chamber stretches before you. A rocky pillar rises to the ceiling, where it meets a cluster of stalactites that hang menacingly overhead. Puddles of water dot the floor, formed by droplets that constantly fall from the mineral formations. The room contains a few empty wooden crates and a small table built into the wall. In the past, this chamber likely served as a place for collecting and sorting the musk.
}}

The crates contain nothing of value, having long since rotted away. On the table lies a pile of ruined documents, most of them unreadable, but one surviving note describes the instructions for exposing the musk to sunlight, as follows:

{{descriptive
##### Instructions for Harvesting the Star Musk
To activate its medicinal properties, star musk must be exposed to sunlight for a few minutes before it is harvested. Each chamber where the plant grows in large amounts uses a different method to provide that sunlight:
* Northeast room: A system of four mirrors reflects sunlight from the entrance into the chamber. The mirrors must be correctly aligned.
* North room: This chamber is too deep within the cave for natural or mechanical illumination, so magical light is required. Spell scrolls containing a sunlight-producing spell are stored in the storage closet in the northwest corridor.
...
The corridor is initially blocked by a pile of fallen rocks, which can be noticed with a DC 10 Wisdom (Perception) check. Clearing the obstruction takes about 5 minutes and reveals the passage to the storage closet.
...
The north chamber is not visible from the crossways. The characters must first descend a steep tunnel to reach the ogres’ lair. If the characters enter the chamber, they must succeed on a DC 10 Dexterity (Stealth) check or the sleeping ogres wake up.

**Alert.** The DC increases by 5 for each of the following or similar actions the characters may have performed earlier in the cave: breaking the lock on the storage closet, fighting the myconids in the pantry, burning the spiderwebs, or entering the room with a bright light source.
...
- If sunlight is restored to the cave: Some chambers slowly return to their former use, and locals may resume harvesting operations.

You can extend the adventure by introducing a new threat attracted to the sunlight or by revealing that the musk’s effects are only the first step in a larger mystery.
...
#### Myconid Rapport Spores

Soft spores produced by myconids to communicate. Two creatures can inhale the spores to communicate telepathically for 1 minute within a 24 meters range, consuming them.

#### Sunlight
*1st-level evocation (Cleric, Druid, Paladin, Ranger, Sorcerer)*
